...
- When writing comments, keep it concise and easy to read. Only add comment if the code is not self-explanatory and additional context would be useful. Refer to guidelines in /home/user/.claude/skills/review-code/comments.md
